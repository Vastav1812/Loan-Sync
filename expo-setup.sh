...
chmod +x expo-setup.sh

echo "Setting up LoanSync as an Expo project..."

# Install necessary Expo packages
echo "Installing Expo core packages..."
npm install expo expo-status-bar expo-updates expo-splash-screen expo-local-authentication
...
echo "Expo setup complete! You can now run the app with:"
echo "npm start"
echo ""
